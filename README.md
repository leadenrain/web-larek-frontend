...
#### Класс Basket
Класс описывает логику работы с корзиной. В конструктор принимает экземпляр брокера событий, содержит геттер для получения списка товаров в корзине, сеттеры для устновки значений свойств, а так же следующие свойства и методы:
