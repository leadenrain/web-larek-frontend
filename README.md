...
В файле index.ts распложен код, выполняющий роль презентера. Он описывает взаимодействие между слоями данных и представления за счет генерируемых событий и обработчиков этих событий. Это взаимодействие наглядно представлено на UML-диаграмме.
...
|* input: change|заполнение поля ввода формы|обновляем данные в модели|
